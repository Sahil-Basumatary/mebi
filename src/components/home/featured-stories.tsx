    ...
    <section id="proof-layer" className="bg-[#000000] text-[#ffffff]">
      <div className="mx-auto w-full max-w-[88rem] px-6 py-28 lg:px-12 lg:py-40">
        <div className="flex items-end justify-between pb-10">
          <KineticLine
            variant="headline"
            className="font-serif text-[clamp(1.7rem,2.6vw,2.4rem)] font-light tracking-[-0.015em] text-[#ffffff]"
          >
            Featured stories
          </KineticLine>
          <KineticLine
            ...
            <KineticLine key={story.title} delay={index * 70} className="group flex flex-col">
              ...
              <div className="flex flex-1 flex-col justify-between gap-8 pt-6">
                <KineticLine
                  ...
                  delay={index * 70 + 40}
                  variant="headline"
                  className="font-serif text-[1.6rem] leading-[1.18] font-light text-[#ffffff]"
                >
                  {story.title}
                </KineticLine>
